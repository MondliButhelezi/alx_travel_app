...
# Database
# Using MySQL configured via environment variables
DATABASES = {
    'default': {
...
# Django REST Framework settings (example, adjust as needed)
REST_FRAMEWORK = {
...
# CORS headers settings - allow all origins (adjust in production!)
CORS_ALLOW_ALL_ORIGINS = True


# Swagger / drf-yasg settings (basic setup)
SWAGGER_SETTINGS = {
